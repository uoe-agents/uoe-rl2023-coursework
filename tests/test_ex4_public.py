...
def test_imports():
    ...
    from rl2023.exercise4.train_ddpg import BIPEDAL_CONFIG as CONFIG

def test_config():
    from rl2023.exercise4.train_ddpg import BIPEDAL_CONFIG
...
def test_restore_file():
    ...
    agent.restore("bipedal_q4_latest.pt")
